...
# Функция для расчета распределения электронов
...
# 1. На корневом узле (далее хост) считываем все необходимые параметры, такие как начальные позиции и скорости электронов,
